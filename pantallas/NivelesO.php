...
<style>
    ...
    .boton-adicional {
        ...
        font-size: 20px; /* Ajustar el tamaño del texto del botón adicional */
        font-weight: bold; /* Ajustar el peso del texto del botón adicional */
        text-transform: uppercase; /* Convertir el texto a mayúsculas */
        border-radius: 5px; /* Agregar borde redondeado al botón adicional */
    }
    ...
    .nivel-facil .boton-adicional {
        background-color: green; /* Cambiar el color del botón "PLAY" para el nivel fácil */
    }

    .nivel-normal .boton-adicional {
        background-color: orange; /* Cambiar el color del botón "PLAY" para el nivel normal */
    }

    .nivel-dificil .boton-adicional {
        background-color: red; /* Cambiar el color del botón "PLAY" para el nivel difícil */
    }
...
<body>
    ...
    <div class="botones-container1">
        ...
        <button onclick="location.href='../nivelDificil_oracion/nivel1.php'" class="boton-adicional">PLAY</button>
    </div>
