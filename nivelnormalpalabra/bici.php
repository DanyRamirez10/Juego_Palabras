...
<body>
  <div id="container">
    <!-- Contenido HTML aquí -->
    <img id="ballImage" src="../imagenes/bici.png" alt="Imagen" width="300" height="200">
    <div id="dropZone"></div>
    <div>
      <div class="clickableElement" data-sound="sound4">cle</div>
      <div class="clickableElement" data-sound="sound5">ta.</div>
      <div class="clickableElement" data-sound="sound5">ci</div>
      <div class="clickableElement" data-sound="sound6">Bi</div>
      <div class="clickableElement" data-sound="sound7">to</div>
  ...
  <audio id="ballAudio" src="../sonidos/Bicicleta.mp3" preload="auto"></audio>
  ...
  <script>
    ...
    var randomSyllables = ['Bi','ci','cle','ta.','to']; // Sílabas aleatorias
...
function showErrorMessage(message) {
  ...
  setTimeout(function() {
    ...
    redirectButton.addEventListener('click', function() {
      window.location.href = 'elefante.php'; // Reemplaza con la URL de redirección correcta
    });
    function goBack() {
      window.location.href = 'cereza.php'; // Reemplaza con la URL para retroceder
    }
    function goBack() {
      window.history.back();
    }
