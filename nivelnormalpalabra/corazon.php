...
<body>
  <div id="container">
    <!-- Contenido HTML aquí -->
    <img id="ballImage" src="../imagenes/corazon.png" alt="Imagen" width="300" height="200">
    <div id="dropZone"></div>
    <div>
      <div class="clickableElement" data-sound="sound4">ca</div>
      <div class="clickableElement" data-sound="sound5">Co</div>
      <div class="clickableElement" data-sound="sound5">ci</div>
      <div class="clickableElement" data-sound="sound6">ra</div>
      <div class="clickableElement" data-sound="sound7">zón</div>
  ...
  <audio id="ballAudio" src="../sonidos/Corazon.mp3" preload="auto"></audio>
  ...
  <script>
    ...
    var randomSyllables = ['Co','ra','zón.','ca','ci']; // Sílabas aleatorias
...
function showErrorMessage(message) {
  ...
  setTimeout(function() {
    ...
    redirectButton.addEventListener('click', function() {
      window.location.href = 'cabeza.php'; // Reemplaza con la URL de redirección correcta
    });
    function goBack() {
      window.location.href = 'caracol.php'; // Reemplaza con la URL para retroceder
    }
    function goBack() {
      window.history.back();
    }
