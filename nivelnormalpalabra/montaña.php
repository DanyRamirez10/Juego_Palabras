...
<body>
  <div id="container">
    ...
    <div id="dropZone"></div>
    <div>
    <div class="clickableElement" data-sound="sound4">Mon</div>
      <div class="clickableElement" data-sound="sound5">ta</div>
      <div class="clickableElement" data-sound="sound5">ña.</div>
      <div class="clickableElement" data-sound="sound6">pa</div>
  ...
  <audio id="ballAudio" src="../sonidos/Montana.mp3" preload="auto"></audio>
  ...
  <script>
    ...
    var randomSyllables = ['Mon', 'ta','ña.','pa']; // Sílabas aleatorias
...
function showErrorMessage(message) {
  ...
  setTimeout(function() {
    ...
    redirectButton.addEventListener('click', function() {
      window.location.href = 'camino.php'; // Reemplaza con la URL de redirección correcta
    });
    function goBack() {
      window.location.href = 'campana.php'; // Reemplaza con la URL para retroceder
    }
    function goBack() {
      window.history.back();
    }
