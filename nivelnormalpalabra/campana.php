...
<body>
  <div id="container">
    <!-- Contenido HTML aquí -->
    <img id="ballImage" src="../imagenes/campana.png" alt="Imagen" width="300" height="200">
    <div id="dropZone"></div>
    <div>
      <div class="clickableElement" data-sound="sound4">Cam</div>
      ...
      <div class="clickableElement" data-sound="sound6">na.</div>
  ...
  <audio id="ballAudio" src="../sonidos/Campana.mp3" preload="auto"></audio>
  ...
  <script>
    ...
    var randomSyllables = ['Cam', 'pa','na.','mi','no']; // Sílabas aleatorias
...
function showErrorMessage(message) {
  ...
  setTimeout(function() {
    ...
    redirectButton.addEventListener('click', function() {
      window.location.href = 'montaña.php'; // Reemplaza con la URL de redirección correcta
    });
    function goBack() {
