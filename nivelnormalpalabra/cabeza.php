...
<body>
  <div id="container">
    <!-- Contenido HTML aquí -->
    <img id="ballImage" src="../imagenes/cabeza.png" alt="Imagen" width="300" height="200">
    <div id="dropZone"></div>
    <div>
      <div class="clickableElement" data-sound="sound4">za.</div>
      <div class="clickableElement" data-sound="sound5">Ca</div>
      <div class="clickableElement" data-sound="sound5">zi</div>
      <div class="clickableElement" data-sound="sound6">en</div>
      <div class="clickableElement" data-sound="sound7">be</div>
  ...
  <audio id="ballAudio" src="../sonidos/Cabeza.mp3" preload="auto"></audio>
  ...
  <script>
    ...
    var randomSyllables = ['Ca','be','za.','en','zi']; // Sílabas aleatorias
...
function showErrorMessage(message) {
  ...
  setTimeout(function() {
    ...
    redirectButton.addEventListener('click', function() {
      window.location.href = 'espejo.php'; // Reemplaza con la URL de redirección correcta
    });
    function goBack() {
      window.location.href = 'corazon.php'; // Reemplaza con la URL para retroceder
    }
    function goBack() {
      window.history.back();
    }
