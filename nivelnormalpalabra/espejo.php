...
<body>
  <div id="container">
    <!-- Contenido HTML aquí -->
    <img id="ballImage" src="../imagenes/espejo.png" alt="Imagen" width="300" height="200">
    <div id="dropZone"></div>
    <div>
      <div class="clickableElement" data-sound="sound4">jo.</div>
      <div class="clickableElement" data-sound="sound5">Es</div>
      <div class="clickableElement" data-sound="sound5">pi</div>
      <div class="clickableElement" data-sound="sound6">ja</div>
      <div class="clickableElement" data-sound="sound7">pe</div>
  ...
  <script>
    ...
    var randomSyllables = ['Es','pe','jo.','ja','pi']; // Sílabas aleatorias
...
function showErrorMessage(message) {
  ...
  setTimeout(function() {
    ...
    redirectButton.addEventListener('click', function() {
      window.location.href = 'escalera.php'; // Reemplaza con la URL de redirección correcta
    });
    function goBack() {
      window.location.href = 'cabeza.php'; // Reemplaza con la URL para retroceder
    }
    function goBack() {
      window.history.back();
    }
