...
@media screen and (max-width: 600px) {
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      var words = ["El", "nido", "está", "en", "la", "rama."];
      ...
      function checkEnteredWords() {
        ...
        if (enteredWordCount === expectedWordCount) {
          ...
          var correctWord = "El nido está en la rama."; // Palabra correcta
      ...
      nextButton.addEventListener("click", function() {
        if (canContinue) {
          window.location.href = "casanaranja.php";
        }
      });
...
<body>
  ...
  <img id="imagen-ninos" src="../imagenes/nido.avif" alt="Niños">
  <!--reproduccion de audio al hacer clic en la imagen-->
  <audio id="audio-imagen" src="../sonidos/oraciones_nivelFacil/nido.mp3"></audio>
  ...
  <div class="keyboard-container">
    <div class="keyboards">
      ...
      <div class="keyboard keyboard-6" data-keyboard="6"></div>
    </div>
  </div>
