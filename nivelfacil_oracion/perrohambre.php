...
@media screen and (max-width: 600px) {
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      var words = ["Él", "perro", "tiene", "hambre."];
      ...
      function checkEnteredWords() {
        ...
        if (enteredWordCount === expectedWordCount) {
          ...
          var correctWord = "Él perro tiene hambre."; // Palabra correcta
      ...
      nextButton.addEventListener("click", function() {
        if (canContinue) {
          window.location.href = "ursula.php";
        }
      });
...
<body>
  ...
  <img id="imagen-ninos" src="../imagenes/perrohambre.png" alt="Niños">
  <!--reproduccion de audio al hacer clic en la imagen-->
  <audio id="audio-imagen" src="../sonidos/oraciones_nivelFacil/perro_hambre.mp3"></audio>
  ...
  <audio id="audio-new" src="../sonidos/bien.mp3"></audio>
