...
body {
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      var words = ["Felipe", "toma", "una", "foto."];
      ...
      function checkEnteredWords() {
        ...
        if (enteredWordCount === expectedWordCount) {
          ...
          var correctWord = "Felipe toma una foto."; // Palabra correcta
      ...
      nextButton.addEventListener("click", function() {
        if (canContinue) {
          window.location.href = "tiatomate.php";
        }
      });
...
<body>
  ...
  <img id="imagen-ninos" src="../imagenes/felipe.jpg" alt="Niños">
   <!--reproduccion de audio al hacer clic en la imagen-->
   <audio id="audio-imagen" src="../sonidos/oraciones_nivelFacil/felipe.mp3"></audio>
