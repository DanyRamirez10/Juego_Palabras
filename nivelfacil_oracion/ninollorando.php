...
@media screen and (max-width: 600px) {
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      var words = ["Él", "niño", "está", "llorando."];
      ...
      function checkEnteredWords() {
        ...
        if (enteredWordCount === expectedWordCount) {
          ...
          var correctWord = "Él niño está llorando."; // Palabra correcta
      ...
      nextButton.addEventListener("click", function() {
        if (canContinue) {
          window.location.href = "perrohambre.php";
        }
      });
...
<body>
  ...
  <img id="imagen-ninos" src="../imagenes/niñollora.png" alt="Niños">
  <!--reproduccion de audio al hacer clic en la imagen-->
  <audio id="audio-imagen" src="../sonidos/oraciones_nivelFacil/nino_llorando.mp3"></audio>
