    ...
    document.addEventListener("DOMContentLoaded", function() {
      ...
      function checkEnteredWords() {
        ...
        if (enteredWordCount === expectedWordCount) {
          ...
          var correctWord = "Úrsula tiene hasma."; // Palabra correcta
      ...
      nextButton.addEventListener("click", function() {
        if (canContinue) {
          window.location.href = "mamahacesopa.php";
        }
      });
...
<body>
  ...
  <img id="imagen-ninos"  src="../imagenes/ursula.jpg" alt="Niños">
  <!--reproduccion de audio al hacer clic en la imagen-->
  <audio id="audio-imagen" src="../sonidos/oraciones_nivelFacil/ursula.mp3"></audio>
  <div class="container">
    <div class="dropZone">
      <div class="syllables">
