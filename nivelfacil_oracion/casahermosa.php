...
<head>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      var words = ["Mimi", "tiene", "hermosa", "casa."];
      ...
      function checkEnteredWords() {
        ...
        if (enteredWordCount === expectedWordCount) {
          ...
          var correctWord = "Mimi tiene hermosa casa."; // Palabra correcta
...
<body>
  ...
  <img id="imagen-ninos" src="../imagenes/casahermosa.avif" alt="Niños">
  <audio id="audio-imagen" src="../sonidos/oraciones_nivelFacil/mimi.mp3"></audio>
  <div class="container">
    <div class="dropZone">
      <div class="syllables">
