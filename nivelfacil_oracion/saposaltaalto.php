    ...
    document.addEventListener("DOMContentLoaded", function() {
      ...
      function checkEnteredWords() {
        ...
        if (enteredWordCount === expectedWordCount) {
          ...
          var correctWord = "El sapo salta alto."; // Palabra correcta
      ...
      nextButton.addEventListener("click", function() {
        if (canContinue) {
          window.location.href = "nidoenlarama.php";
        }
      });
...
<body>
  ...
  <img id="imagen-ninos" src="../imagenes/sapo.webp" alt="Niños">
  <!--reproduccion de audio al hacer clic en la imagen-->
  <audio id="audio-imagen" src="../sonidos/oraciones_nivelFacil/sapo.mp3"></audio>
