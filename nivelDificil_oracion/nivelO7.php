...
<head>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      var words = ["Pedro", "juega", "con", "su", "trompo."];
      ...
      function checkEnteredWords() {
        ...
        if (enteredWordCount === expectedWordCount) {
          ...
          var correctWord = "Pedro juega con su trompo."; // Palabra correcta
      ...
      nextButton.addEventListener("click", function() {
        if (canContinue) {
          window.location.href = "nivelO8.php";
        }
      });
...
<body>
  ...
  <img id="imagen-ninos" src="../imagenesO/trompo.jpg" alt="Niños">
  <!--reproduccion de audio al hacer clic en la imagen-->
  <audio id="audio-imagen" src="../sonidos/oraciones_nivelDificil/pedro.mp3"></audio>
