    ...
    document.addEventListener("DOMContentLoaded", function() {
      ...
      function checkEnteredWords() {
        ...
        if (enteredWordCount === expectedWordCount) {
          ...
          var correctWord = "El toro brama."; // Palabra correcta
      ...
      nextButton.addEventListener("click", function() {
        if (canContinue) {
          window.location.href = "nivelO3.php";
        }
      });
...
<body>
  ...
  <img id="imagen-ninos" src="../imagenesO/torobrama.jpg" alt="Niños">
  <!--reproduccion de audio al hacer clic en la imagen-->
  <audio id="audio-imagen" src="../sonidos/oraciones_nivelDificil/toro_brama.mp3"></audio>
  ...
  <audio id="audio-error" src="../sonidos/erro.mp3"></audio>
