    ...
    document.addEventListener("DOMContentLoaded", function() {
      ...
      function checkEnteredWords() {
        ...
        if (enteredWordCount === expectedWordCount) {
          ...
          var correctWord = "Lucas leé un libro."; // Palabra correcta
      ...
      nextButton.addEventListener("click", function() {
        if (canContinue) {
          window.location.href = "nivelO10.php";
        }
      });
...
<body>
  ...
  <img id="imagen-ninos" src="../imagenesO/lucas.jpg" alt="Niños">
   <!--reproduccion de audio al hacer clic en la imagen-->
   <audio id="audio-imagen" src="../sonidos/oraciones_nivelDificil/lucas.mp3"></audio>
