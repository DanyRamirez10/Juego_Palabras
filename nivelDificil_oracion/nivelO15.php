...
<head>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      var words = ["Camila", "pesa", "20",  "kilos."];
      ...
      function checkEnteredWords() {
        ...
        if (enteredWordCount === expectedWordCount) {
          ...
          var correctWord = "Camila pesa 20 kilos."; // Palabra correcta
...
<body>
  ...
  <img id="imagen-ninos" src="../imagenesO/pesa.jpg" alt="Niños">
   <!--reproduccion de audio al hacer clic en la imagen-->
   <audio id="audio-imagen" src="../sonidos/oraciones_nivelDificil/camila.mp3"></audio>
