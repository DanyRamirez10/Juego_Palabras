...
<head>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      var words = ["Lucía", "compró","un", "mueble."];
      ...
      function checkEnteredWords() {
        ...
        if (enteredWordCount === expectedWordCount) {
          ...
          var correctWord = "Lucía compró un mueble."; // Palabra correcta
      ...
      nextButton.addEventListener("click", function() {
        if (canContinue) {
          window.location.href = "nivelO4.php";
        }
      });
...
<body>
  ...
  <img id="imagen-ninos" src="../imagenesO/mueble.jpg" alt="Niños">
  <!--reproduccion de audio al hacer clic en la imagen-->
  <audio id="audio-imagen" src="../sonidos/oraciones_nivelDificil/lucia.mp3"></audio>
