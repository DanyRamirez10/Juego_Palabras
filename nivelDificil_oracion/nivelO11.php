...
<head>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      var words = ["Gloria", "sale", "de",  "paseo."];
      ...
      function checkEnteredWords() {
        ...
        if (enteredWordCount === expectedWordCount) {
          ...
          var correctWord = "Gloria sale de paseo."; // Palabra correcta
      ...
      nextButton.addEventListener("click", function() {
        if (canContinue) {
          window.location.href = "nivelO12.php";
        }
      });
...
<body>
  ...
  <img id="imagen-ninos" src="../imagenesO/paseo.webp" alt="Niños">
  <!--reproduccion de audio al hacer clic en la imagen-->
  <audio id="audio-imagen" src="../sonidos/oraciones_nivelDificil/gloria.mp3"></audio>
