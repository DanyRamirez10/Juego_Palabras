...
<head>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      var words = ["Juanito", "tiene", "un", "reloj."];
      ...
      function checkEnteredWords() {
        ...
        if (enteredWordCount === expectedWordCount) {
          ...
          var correctWord = "Juanito tiene un reloj."; // Palabra correcta
      ...
      nextButton.addEventListener("click", function() {
        if (canContinue) {
          window.location.href = "burrocomepasto.php";
        }
      });
...
<body>
  ...
  <img id="imagen-ninos" src="../imagenesO/reloj.avif" alt="Niños">
  <!--reproduccion de audio al hacer clic en la imagen-->
  <audio id="audio-imagen" src="../sonidos/oraciones_nivelMedio/juanito.mp3"></audio>
