...
<head>
  <style>
    ...
    font-size: 58px;
      ...
      width: 190px; /* Ajusta el valor según lo que necesites */
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      var words = ["Verónica", "come", "pavo", "asado."];
      ...
      function checkEnteredWords() {
        ...
        if (enteredWordCount === expectedWordCount) {
          ...
          var correctWord = "Verónica come pavo asado."; // Palabra correcta
...
<body>
  ...
  <img id="imagen-ninos" src="../imagenesO/niñacomepavo.webp" alt="Niños">
   <!--reproduccion de audio al hacer clic en la imagen-->
   <audio id="audio-imagen" src="../sonidos/oraciones_nivelMedio/veronica.mp3"></audio>
