...
<head>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      var words = ["El", "pato", "se", "lastimó", "la", "patita."];
      ...
      function checkEnteredWords() {
        ...
        if (enteredWordCount === expectedWordCount) {
          ...
          var correctWord = "El pato se lastimó la patita."; // Palabra correcta
...
<body>
  ...
  <img id="imagen-ninos" src="../imagenesO/patolastimado.webp" alt="Niños">
   <!--reproduccion de audio al hacer clic en la imagen-->
   <audio id="audio-imagen" src="../sonidos/oraciones_nivelMedio/pato.mp3"></audio>
