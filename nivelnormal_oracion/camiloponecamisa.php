...
<head>
  <style>
    ...
    font-size: 58px;
      ...
      width: 160px; /* Ajusta el valor según lo que necesites */
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      var words = ["Camilo", "se", "pone", "su", "camisa."];
      ...
      function checkEnteredWords() {
        ...
        if (enteredWordCount === expectedWordCount) {
          ...
          var correctWord = "Camilo se pone su camisa."; // Palabra correcta
      ...
      nextButton.addEventListener("click", function() {
        if (canContinue) {
          window.location.href = "tomasausamuletas.php";
        }
      });
...
<body>
  ...
  <img  id="imagen-ninos" src="../imagenesO/camia.webp" alt="Niños">
   <!--reproduccion de audio al hacer clic en la imagen-->
   <audio id="audio-imagen" src="../sonidos/oraciones_nivelMedio/camisa.mp3"></audio>
