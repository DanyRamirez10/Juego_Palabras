...
<head>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      var words = ["La", "niña", "tiene", "un", "año."];
      ...
      function checkEnteredWords() {
        ...
        if (enteredWordCount === expectedWordCount) {
          ...
          var correctWord = "La niña tiene un año."; // Palabra correcta
...
<body>
  ...
  <img id="imagen-ninos" src="../imagenesO/niñaunaño.webp" alt="Niños">
  <!--reproduccion de audio al hacer clic en la imagen-->
  <audio id="audio-imagen" src="../sonidos/oraciones_nivelMedio/nina.mp3"></audio>
