...
<head>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      var words = ["Mi", "mamá", "limpia", "la", "mesa."];
      ...
      function checkEnteredWords() {
        ...
        if (enteredWordCount === expectedWordCount) {
          ...
          var correctWord = "Mi mamá limpia la mesa."; // Palabra correcta
...
<body>
  ...
  <img id="imagen-ninos" src="../imagenesO/mamalimpiamesa.png" alt="Niños">
   <!--reproduccion de audio al hacer clic en la imagen-->
   <audio id="audio-imagen" src="../sonidos/oraciones_nivelMedio/mama_limpia.mp3"></audio>
