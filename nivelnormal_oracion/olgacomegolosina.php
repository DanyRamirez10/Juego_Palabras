...
<head>
  <style>
    ...
    font-size: 58px;
      ...
      width: 210px; /* Ajusta el valor según lo que necesites */
    ...
    document.addEventListener("DOMContentLoaded", function() {
      ...
      function checkEnteredWords() {
        ...
        if (enteredWordCount === expectedWordCount) {
          ...
          var correctWord = "Olga come golosinas."; // Palabra correcta
      ...
      nextButton.addEventListener("click", function() {
        if (canContinue) {
          window.location.href = "vacaleche.php";
        }
      });
...
<body>
  ...
  <img id="imagen-ninos" src="../imagenesO/olgagolosinas.jpg" alt="Niños">
  <!--reproduccion de audio al hacer clic en la imagen-->
  <audio id="audio-imagen" src="../sonidos/oraciones_nivelMedio/olga.mp3"></audio>
