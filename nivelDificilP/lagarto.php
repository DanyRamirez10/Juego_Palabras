...
<body>
    ...
    <button id="redireccionar" onclick="javascript:window.location.href = 'naranja.php';" disabled></button>
    <button id="volver" onclick="javascript:window.location.href = 'caballo.php';"></button>
...
<audio id="audioFelicitaciones" src="../sonidos/felicidades.mp3"></audio>
    <script>
        ...
        imagen1.src = "../imagenes/lagarto.png";
        palabras_array.push("LAGARTO");
        ...
        function horca(errores) {
            ...
            imagen.src = "../imagenes/lagarto.png";
