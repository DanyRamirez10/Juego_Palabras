...
<body>
    ...
    <button id="redireccionar" onclick="javascript:window.location.href = 'luna.php';" disabled></button>
    <button id="volver" onclick="javascript:window.location.href = 'coche.php';"></button>
...
<audio id="audioFelicitaciones" src="../sonidos/felicidades.mp3"></audio>
    <script>
        ...
        imagen1.src = "../imagenes/ tren.png";
        palabras_array.push("TREN");
