...
<body>
    ...
    <button id="redireccionar" onclick="javascript:window.location.href = 'felicidades.php';" disabled></button>
    <button id="volver" onclick="javascript:window.location.href = 'cuchillo.php';"></button>
...
<audio id="audioFelicitaciones" src="../sonidos/bien.mp3"></audio>
    <script>
        ...
        var aciertos = 0;
        var errores = 0;
        var maxErrores = 10; // Número máximo de errores permitidos

        /* Palabra e imagen fija */
        var imagen1 = new Image();
        imagen1.src = "../imagenes/dino.png";
