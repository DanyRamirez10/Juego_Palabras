...
<body>
    ...
    <button id="redireccionar" onclick="javascript:window.location.href = 'cuchillo.php';" disabled></button>
    <button id="volver" onclick="javascript:window.location.href = 'lagarto.php';"></button>
...
<audio id="audioFelicitaciones" src="../sonidos/bien.mp3"></audio>
    <script>
        ...
        imagen1.src = "../imagenes/naranja.png";
        ...
        function horca(errores) {
            ...
            imagen.src = "../imagenes/naranja.png";
