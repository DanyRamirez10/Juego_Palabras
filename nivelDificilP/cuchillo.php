...
<body>
    ...
    <button id="redireccionar" onclick="javascript:window.location.href = 'dino.php';" disabled></button>
    <button id="volver" onclick="javascript:window.location.href = 'naranja.php';"></button>
...
<audio id="audioFelicitaciones" src="../sonidos/felicidades.mp3"></audio>
    <script>
        ...
        var aciertos = 0;
        var errores = 0;
        var maxErrores = 8; // Número máximo de errores permitidos

        /* Palabra e imagen fija */
        var imagen1 = new Image();
        imagen1.src = "../imagenes/cuchillo.png";
        palabras_array.push("CUCHILLO");
        ...
        function horca(errores) {
            ...
            imagen.src = "../imagenes/cuchillo.png";
