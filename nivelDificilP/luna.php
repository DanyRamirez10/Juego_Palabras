...
<body>
    ...
    <button id="redireccionar" onclick="javascript:window.location.href = 'juego.php';" disabled></button>
    <button id="volver" onclick="javascript:window.location.href = 'tren.php';"></button>
